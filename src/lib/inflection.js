...
vzor[nvz++] = new Array( "ž","moje", "mé",   "mé",   "mou",  "má",   "mé",  "mou",  "moje", "mých","mým","mé","mé","mých","mými" )
vzor[nvz++] = new Array( "s","mé",   "mého", "mému", "mé",   "moje", "mém", "mým",  "mé",   "mých","mým","má","má","mých","mými" )
vzor[nvz++] = new Array( "s","moje", "mého", "mému", "moje", "moje", "mém", "mým",  "moje", "mých","mým","má","má","mých","mými" )
...
vzor[nvz++] = new Array( "m","-pan", "pana","panu","pana","pane","panu",  "panem","páni/pánové","pánů","pánům","pány","páni/pánové","pánech","pány" )
vzor[nvz++] = new Array( "s","moře", "moře","moři","moře","moře","moři","mořem","moře","moří","mořím","moře","moře","mořích","moři" )
vzor[nvz++] = new Array( "-","dveře", "","","","","","","dveře","dveří","dveřím","dveře","dveře","dveřích","dveřmi" )
vzor[nvz++] = new Array( "-","housle", "","","","","","","housle","houslí","houslím","housle","housle","houslích","houslemi" )
vzor[nvz++] = new Array( "-","šle", "","","","","","","šle","šlí","šlím","šle","šle","šlích","šlemi" )
vzor[nvz++] = new Array( "-","muka", "","","","","","","muka","muk","mukám","muka","muka","mukách","mukami" )
vzor[nvz++] = new Array( "s","ovoce", "ovoce","ovoci","ovoce","ovoce","ovoci","ovocem","","","","","","","" )
vzor[nvz++] = new Array( "m","humus", "humusu","humusu","humus","humuse","humusu","humusem","humusy","humusů","humusům","humusy","humusy","humusech","humusy" )
...
vzor[nvz++] = new Array( "m","Zeus", "Dia","Diovi","Dia","Die","Diovi","Diem","Diové","Diů","Diům","?","Diové","?","?" )
...
vzor[nvz++] = new Array( "m","-[mnp]en","0enu/0ena","0enu/0enovi","0en/0na","0ene", "0enu/0enovi",  "0enem", "-0eny/0enové",  "0enů","0enům","0eny",  "0eny/0enové",  "0enech", "0eny" )
vzor[nvz++] = new Array( "m","-[bcčdstvz]en","0nu/0na","0nu/0novi","0en/0na","0ne", "0nu/0novi",  "0nem", "-0ny/0nové",  "0nů","0nům","0ny",  "0ny/0nové",  "0nech", "0ny" )
...
vzor[nvz++] = new Array( "m","-[h]",            "0u/0a",   "0u/0ovi",  "0/0a",  "0u", "0u/0ovi",  "0em",     "-0y/0ové",  "0ů","0ům","0y",    "0y/0ové",  "zích", "0y" )
...
// změny rodu
vzor[nvz++] = new Array( "ž","-ar",      "ary", "aře", "ar", "ar", "ar", "ar",    "ary", "ar", "arám", "ary", "ary", "arách", "arami" )
vzor[nvz++] = new Array( "ž","-am",      "am",  "am",  "am", "am", "am", "am",    "am", "am", "am", "am", "am", "am", "am" )
vzor[nvz++] = new Array( "ž","-er",      "er", "er", "er", "er", "er", "er",    "ery", "er", "erám", "ery", "ery", "erách", "erami" )

vzor[nvz++] = new Array( "m","-oe",      "oema", "oemovi", "oema", "oeme", "emovi", "emem",    "oemové", "oemů", "oemům", "oemy", "oemové", "oemech", "oemy" )
...
v1[nv1++] = new Array( "kotel", "kotl", "kotel" );
...
function Sklon( nPad, vzndx, txt )
{
  ...
  if(nPad==1 ) // 1. pad nemenime
    rv = Xdetene( txt3 );
  else
    rv = LeftStr( kndx, txt3 ) + '-' + CmpFrm(vzor[vzndx][nPad]);
...
//
function OnSklonuj(value, zivotne, rod) {
  var aTxt, i, j;
  ...
  for( i=aTxt.length-1; i>=0; i-- ) {
    ...
    singular[2] = astrTvar[3];
    singular[3] = astrTvar[4];
    singular[4] = astrTvar[5];
    singular[5] = astrTvar[6];
    singular[6] = astrTvar[7];

    plural[0] = astrTvar[8];
    plural[1] = astrTvar[9];
    plural[2] = astrTvar[10];
    plural[3] = astrTvar[11];
    plural[4] = astrTvar[12];
    plural[5] = astrTvar[13];
    plural[6] = astrTvar[14];
  }
...
function StdNdx(slovo)
{
  ...
  {
    // filtrace rodu
    if(  PrefRod.charAt(0) != "0" && PrefRod.charAt(0) != vzor[iii][0].charAt(0) )
      continue;
